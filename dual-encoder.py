...
class T5LayerNorm(nn.Module):  # Implement Layer Normalization in the style of the T5 model
...
# The path of the source file: C:\Anaconda\envs\rxnfp-1\Lib\site-packages\transformers\models\t5\modeling_t5.py